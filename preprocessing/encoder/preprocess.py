...
def _preprocess_speaker_dirs(speaker_dirs, dataset_name, datasets_root, out_dir, extension,
    ...
    def preprocess_speaker(speaker_dir: Path):
        ...
        for in_fpath in speaker_dir.glob("**/*.%s" % extension):
            ...
            out_fname_mfcc = "_".join(in_fpath.relative_to(speaker_dir).parts)
            out_fname_mfcc = out_fname_mfcc.replace(".%s" % extension, "_mfcc.npy")
            # print(out_fname_mfcc)
            ...
            out_fpath_mfcc = speaker_out_dir.joinpath(out_fname_mfcc)
            # print(out_fpath_mfcc)
            np.save(out_fpath, frames)
            # np.save(out_fpath_mfcc, mfcc)
            # if dataset_name != 'VCTK-Corpus/wav16' or dataset_name != 'VIVOS/wav16':
            #     print('logging VIVOS')
