...
def encoding_visualization(z, estimation_dir, i, epoch, prefix):
    ...
    plt.savefig(os.path.join(estimation_dir, prefix+'_'+str(epoch)+'_latent_code_'+str(i)+'.png'))
    return idx
...
# def plot_utt_latentvt_analysis(latent_vectors, estimation_dir, speaker_id):
